...
The Uvuka office location is likely to be In Longmeadow, Johannesburg. This will allow the business to have better contact with the customers in Gauteng and Kwa-Zulu Natal that we plan to serve. It also offers a cost-effective rental compared to an equivalent premises in Cape Town.
...
\begin{tabular}{p{0.3\textwidth}k{0.7\textwidth}}%{@{ }ll}
...
\section{Layout of Business Plan}
...
\section{Uvuka's Competitive Advantage}
...
\vskip10pt
\caption[Provincial fatalities for the period from 1 December 2014 to 7 January 2015]{Provincial fatalities for the period from 1 December 2014 to \linebreak 7 January 2015 from \cite{ProvincialFestiveStats}}
...
The first year of operation does not require as much capital as the second year as most of the first year is spent developing the product. Furthermore, when the product is developed, it does not require a large capital investment to manufacture it as this process can be outsourced.
...
The next few years of operation mainly consist of developing a larger product range for the expanding target market. A focus is laid on marketing in order to maintain a competitive edge as sales and production continue to increase. \Cref{fig:Gantt Chart 2} displays a Gantt chart of the next four years of operation of Uvuka and estimates the first dividends paid out to investors will occur after the fourth year of operation in 2019.
...
%Make the right choices, stay awake, stay alive and invest in Uvuka.
\vskip50pt

\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{images/uvuka_logo_ben}
