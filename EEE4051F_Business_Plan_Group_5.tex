...
\begin{tabular}{@{ }ll}
    ...
    Algorithm: a process 
    Global Positioning System:	&	a satellite-based navigation system typically accurate to within 10 m \\
...
The current sales projections outlined in the finance section are sales goals set to ensure that the company makes a profit. The expected ramp-up in sales is due to the Uvuka brand becoming know and trusted and sales to new customers increasing as a result. Furthermore, the number of private vehicles is also expected to increase. Once the product is marketed to these customers, there should be a larger customer base to which we can market our product.
...
The Gantt chart seen in  \cref{fig:Gantt Chart 1} below is a visual representation of the predicted timeline for Uvuka during the first year of operation. During the first year of business operation, all market research and product development will have been completed. The critical activity for this period is the development of the product prototype. Successful completion of this task by the 
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{Gantt_1.PNG}
\vskip10pt
...
As can be seen from \cref{tab:rm}, the probability of the risk situations occuring is decreased through implementation of the mitigation strategies. Most of the situations as outlined above have already been addressed in this business plan. However, as a new company, new risks will always arise. Because of this, Uvuka are committed to meeting once every two months to review the risks and the mitigation strategies, and to evaluate if the current mitigation strategies are working as well as to identify and plan for previously unforeseen risks.
...
%TODO - add more detail for the technical description of some of these features perhaps. - don't think any more info is needed here? -L
